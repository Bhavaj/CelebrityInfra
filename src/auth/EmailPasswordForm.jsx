  ...
  return (
    <div>
      ...
      <button type="button" onClick={() => { setMode("reset"); setMsg(""); }}
        style={{ background: "none", border: "none", color: C.muted, cursor: "pointer", fontSize: 13, marginTop: 14, padding: 0, fontFamily: "'Outfit',sans-serif", textDecoration: "underline" }}>
