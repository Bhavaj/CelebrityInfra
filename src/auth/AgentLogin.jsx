...
export default function AgentLogin({ onBack }) {
  ...
  return (
    <AuthShell eyebrow="Agent" title={tab === "signin" ? "Sign in" : "Create account"} subtitle="Track your customers & commission">
